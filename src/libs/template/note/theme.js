...
export const themeChoice = {
  ...
  public () {
    ...
    document.styleSheets[0].insertRule(`._um-_unfold-box { height: 16px; line-height: 16px; font-size: 10px; cursor: pointer; position: absolute; left: 5px; top: 0; }`)
    document.styleSheets[0].insertRule(`._um-_unfold-text { transition: .3s; position: absolute; top: 0; }`)
    document.styleSheets[0].insertRule(`._um-_unfold-scale-text { transform: scale(.75); -webkit-transform: scale(.75); -moz-transform: scale(.75); -o-transform: scale(.75); -ms-transform: scale(.75); transform-origin: left center; -webkit-transform-origin: left center; -moz-transform-origin: left center; -o-transform-origin: left center; -ms-transform-origin: left center; }`)
    document.styleSheets[0].insertRule(`._um-_unflod-arrow { line-height: 16px; transform-origin: left center; transition: .3s; position: absolute; top: -1px; }`)
    ...
    document.styleSheets[0].insertRule(`._um-_submit-item-cancel,._um-_submit-item-ok { width: 20px; height: 12px; line-height: 12px; text-align: center; border-radius: 6px; font-size: 12px; float: left; margin: 0 4px; cursor: pointer; }`)
